...
const shopperSampleData = [
  {
    ...
    phone: 9897459918,
    address:
      '52W5+3RW, Chilli Int Rd, Ghaatia Azam Khan, Civil Lines, Agra, Uttar Pradesh 282002',
    openingTime: '',
    closingtime: '',
    longitude: '27.194824',
    latitude: '78.008716',
    products: [
      ...
      },
      {
        ...
        category: 'Breakfast & Instant Food',
        rating: 4.3,
        img: indian_lentil_dahl_masoor_dal,
      },
      {
        item_id: 4,
        productName: 'Sugar',
      ...
      {
        item_id: 17,
        productName: 'Toothpaste (Colgate)',
        productPrice: 50,
        discount: 0.4,
        category: 'Bathroom & Toiletries',
        rating: 4.3,
  ...
  },
  {
    ...
    products: [
      ...
      {
        item_id: 52,
        productName: 'Cereals (Corn Flakes)',
        productPrice: 60,
        discount: 0.7,
        category: 'Breakfast & Instant Food',
        rating: 4.3,
  ...
  },
  {
    ...
    phone: 9876123450,
    address:
      '2/4, Sardar Patel Marg, Rajaji Nagar, Bangalore, Karnataka 560010',
    ...
    products: [
      ...
      {
        id: 3,
        productName: 'Wheat Flour (Chakki Fresh)',
        productPrice: 40,
        discount: 0.6,
        category: 'Breakfast & Instant Food',
        rating: 4.3,
      ...
      {
        id: 3,
        productName: 'Ginger Garlic Paste',
        productPrice: 35,
        discount: 0.4,
        category: 'Spices & Condiments',
        rating: 4.3,
  ...
  },
  {
    ...
    products: [
      ...
      {
        item_id: 64,
        productName: 'Cereal Bars (Mixed Fruit)',
        productPrice: 25,
        discount: 0.5,
        category: 'Snacks & Munchies',
        rating: 4.3,
